  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container-custom py-16 mt-16 flex-grow">
        <h1 className="text-4xl font-extrabold mb-8 text-center">Terms &amp; Conditions</h1>
        <div className="space-y-10 text-gray-800 max-w-3xl mx-auto">
          <section>
            <h2 className="text-2xl font-bold mb-4 text-blue-700">Legal Notice</h2>
            <p className="mb-2">
              <span className="font-semibold">Electronic Record:</span> This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.
            </p>
            <p className="mb-2">
              <span className="font-semibold">Publication:</span> This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://vkwash.in/" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://vkwash.in/</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            <p className="mb-2">
              <span className="font-semibold">Ownership:</span> The Platform is owned by <span className="font-semibold">ODURI VIJAY KUMAR</span>, a company incorporated under the Companies Act, 1956 with its registered office at GANDIPET GANDIPET Block GANDIPET GANDIPET City Hyderabad State TELANGANA District RANGA REDDI, Pin 500075, Hyderabad, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
            </p>
          </section>
          <section>
            <h2 className="text-2xl font-bold mb-4 text-blue-700">Terms of Use</h2>
            <p className="mb-2">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-4 rounded">
              <span className="font-semibold text-blue-700">IMPORTANT:</span> ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.
            </div>
            <p className="mb-2">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Sharing</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Security Precautions</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Data Deletion and Retention</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Consent</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Changes to this Privacy Policy</h3>
                <p>
